...
int[] MultiplicationFirstLastNum(int[] array)
{
    ...
    for (int i = 0; i < newArray.Length; i++)         // [1, 2, 3, 4, 5]
    {
...
int[] arr = CreateArrayRndInt(11, 0, 100);
PrintArray(arr);
int[] multiplicationFirstLastNum = MultiplicationFirstLastNum(arr);
PrintArray(multiplicationFirstLastNum);